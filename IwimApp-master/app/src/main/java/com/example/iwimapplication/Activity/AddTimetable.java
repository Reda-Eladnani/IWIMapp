...
public class AddTimetable extends AppCompatActivity implements View.OnClickListener{
    ...
    public void addEmploiInfo(final Emploi emploi){
        ...
        final String name = emploi.getAnnee()+" "+emploi.getSemestre()+" "+emploi.getPeriode()+" "+emploi.getSemaine();
        ...
        db.collection("emploiInfo")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        Notifications.AddNotif(userId,"Chef de filière","Un emploi du temps a été ajouté: "+name,"etudiants");
                        Notifications.AddNotif(userId,"Chef de filière","Un emploi du temps a été ajouté: "+name,"professeurs");
                    }
                })
                ...
                reference.child(fileName).setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AddTimetable.this, "Problème d'ajouter ce emploi du temps", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
