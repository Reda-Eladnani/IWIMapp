...
public class DownloadTimetable extends AppCompatActivity implements View.OnClickListener{
    private static final String TAG = "DownloadTimetable" ;
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.a_back){
            startActivity(new Intent(DownloadTimetable.this, Home.class));
            finish();
        }
    }
